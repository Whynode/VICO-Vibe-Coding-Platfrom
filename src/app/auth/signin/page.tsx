      ...
      <div className="w-full max-w-md relative z-10">
        <div className="sm:mx-auto sm:w-full">
          ...
          <p className="mt-2 text-center text-[14px] text-gray-400">
            {t("auth.no_account")}{" "}
            <Link href="/auth/signup" className="font-semibold text-white hover:text-gray-300 transition-colors">
            ...
            <div className="flex items-center justify-between pt-1">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 rounded border border-white/5 bg-[#050505] focus:ring-white"
                />
                <label htmlFor="remember-me" className="ml-2 block text-[13px] text-gray-400">
                  {t("auth.remember_me")}
                </label>
              </div>
